...
{
    public class Contacts_V130: DataAccess
    {
        public Contacts_V130(string sConnString)
            : base(sConnString)
        {
        ...
        public DataSet ManageWebContacts(int userID, string name, string mobileNumber, string prefix, int contactID, int mode,int listID, out int returnValue, out string returnMessage, string path,out int contactId)
        {
            SqlCommand sqlCmd = default(SqlCommand);
            SqlConnection sqlCon = null;
            SqlDataAdapter da = null;
            ...
            try
            {
                ...
                sqlCmd.CommandType = CommandType.StoredProcedure;
                sqlCmd.Parameters.Add("@UserID", SqlDbType.Int).Value = userID;
                sqlCmd.Parameters.Add("@Name", SqlDbType.VarChar, 200).Value = name;
        ...
        public DataSet UploadExcelData(int userID, DataTable dt, out int returnValue, out string returnMessage,int listId)
        {
            SqlCommand sqlCmd = default(SqlCommand);
            SqlConnection sqlCon = null;
            SqlDataAdapter da = null;
