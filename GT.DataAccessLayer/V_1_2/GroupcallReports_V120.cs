...
{
    public class GroupcallReports_V120 : DataAccess
    {
        ...
        public GroupcallReports_V120(string sConnString)
            : base(sConnString)
        {
        ...
        public DataSet GetReportsByBatchIdNew(int userID, int grpCallID, string batchID, out int retVal, out string retMessage, out short IsCallFromBonus)
        {
            SqlCommand sqlCmd = default(SqlCommand);
            SqlConnection sqlCon = null;
            SqlDataAdapter da = null;
            ...
            try
            {
                ...
                sqlCon = new SqlConnection();
                sqlCon = Connection;
                sqlCmd = new SqlCommand("GrptalkReports", sqlCon);
                sqlCmd.CommandType = CommandType.StoredProcedure;
                ...
                //sqlCmd.Parameters.Add("@IsConfRecorded", SqlDbType.TinyInt).Direction = ParameterDirection.Output;
