...
{
    public class Groups_V120 : DataAccess
    {
        public Groups_V120(string sConnString)
            : base(sConnString)
        {

        }
        /// <summary>
        /// This Function Is used to Leave member from group
        /// </summary>
        /// <param name="accessToken"></param>
        /// <param name="grpTalkID"></param>
        /// <param name="leaveStatus"></param>
        /// <param name="hostName"></param>
        /// <param name="hostMobile"></param>
        /// <param name="retVal"></param>
        /// <param name="retMessage"></param>
        public void MemberLeaveFromGrpCall(int userId, int grpTalkID, out short leaveStatus, out string grpTalkName, out string deviceToken, out short osID, out string hostMobile, out string schTime, out short retVal, out string retMessage, out string leaveMemName)
        {
        ...
        /// </summary>
        public DataSet CreateGrpCall(DataTable conferenceMembers, int userId, grpcreate grpObj, int HostIsDND, out short retVal, out string retMessage)
        {
            ...
            try
            {
                ...
                sqlCon = Connection;
                sqlCmd = new SqlCommand("CreateGroupCallNew", sqlCon);
                ...
                sqlCmd.Parameters.Add("@IsMuteDial", SqlDbType.TinyInt).Value = 0;
        ...
        public DataSet EditGroupCall(DataTable grpCallMembers, int userId, grpEdit grpObj, out short retVal, out string retMessage)
        {
            SqlCommand sqlCmd = default(SqlCommand);
            SqlConnection sqlCon = null;
            SqlDataAdapter da = null;
            ...
            try
            {
                ...
                grpObj.grpCallTime = grpObj.grpCallTime.Replace("p.m.", "pm");
                sqlCon = Connection;
                sqlCmd = new SqlCommand("EditGroupCallNew", sqlCon);
                sqlCmd.CommandType = CommandType.StoredProcedure;
                sqlCmd.Parameters.Add("@UserId", SqlDbType.BigInt).Value = userId;
        ...
        //public DataSet GetAllGroupCalls(int userId, int AppSource, string DeviceToken, string AppVersion, string TimeStamp, out string outTimeStamp, out int count, out double userBal, out string profileImagePath, out string userCurrentDate, out string userRegTimeStamp, out int retVal, out string retMessage)
        //{
        ...
        //    {
        //        sqlCon = Connection;
        //        sqlCmd = new SqlCommand("GetAllGroupCallsNew", sqlCon);
        //        sqlCmd.CommandType = CommandType.StoredProcedure;
        ...
        public string DeleteGroupCall(int groupCallID, out int retVal)
        {
            SqlCommand sqlCmd = default(SqlCommand);
            SqlConnection sqlCon = null;
            try
        ...
        public DataSet GetConferenceRoom(int confID, int userID, out short retVal, out string retMsg, out string serverTime, out string startTime)
        {
        ...
        public DataSet SaveContactsToConference(DataTable members, int userID, int confID, out int retVal, out string retMessage)
        {
            ...
            try
            {
                sqlCmd = new SqlCommand("savecontacts_to_conference", sqlCon);
                sqlCmd.CommandType = CommandType.StoredProcedure;
                sqlCmd.Parameters.Add("@userid", SqlDbType.Int).Value = userID;
        ...
        public string GrpCallCancel(int ConferenceID, out int retVal, out string LastCallDate)
        {
            SqlCommand sqlCmd = default(SqlCommand);
            SqlConnection sqlCon = null;
            try
        ...
        public DataSet CheckUserConfirmation(string Mobile, out int retVal, out string RetMessage, out  bool isConfirmed)
        {
            SqlCommand sqlCmd = default(SqlCommand);
            SqlConnection sqlCon = null;
            DataSet ds = new DataSet();
