...
{
    public class GroupCall_V120 : DataAccess
    {
        public GroupCall_V120(string sConnString)
            : base(sConnString)
        {
        ...
        /// <param name="token"></param>
        /// <returns></returns>
        public DataSet ValidateGrpCall(grpcall grpCallProp, out short retVal, out string retMsg, out string callUUID, out long instanceId)
        {
            SqlCommand sqlCmd = default(SqlCommand);
            SqlConnection sqlCon = null;
        ...
        /// <returns></returns>
        public DataSet GrpCallDialEnt(grpcall grpCallPropObj, out short retVal, out string retMsg, out int durationLimit, out short isCallFromBonus, out int isPaidClient,out string sendDigitsString)
        {
