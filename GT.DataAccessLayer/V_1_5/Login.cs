...
namespace GT.DataAccessLayer.V_1_5
{
    ...
    {
        public Login(string sConnString)
            : base(sConnString)
        {
        ...
        public DataSet ValidateOTP(string mobile, string OTP, string txnID, int isRegisteredFromWeb, out short retVal, out string retMsg, out int errorCode)
        {
            ...
            try
            {
                ...
                sqlCmd.Parameters.Add("@Browser",SqlDbType.VarChar,30).Value= HttpContext.Current.Request.Browser.Browser;
                sqlCmd.Parameters.Add("@RegisteredIpAddress", SqlDbType.VarChar, 14).Value =HttpContext.Current.Request.ServerVariables["REMOTE_ADDR"].ToString();
        ...
        public DataSet Registration(RegistrationDetails details, out short isExisted, out short retVal, out string retMsg, out int errorCode)
        {
            ...
            try
            {
                ...
                sqlCmd.Parameters.Add("@UserName", SqlDbType.VarChar, 30).Value = details.UserName;
