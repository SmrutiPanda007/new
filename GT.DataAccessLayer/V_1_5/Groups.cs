...
{
    public class Groups : DataAccess
    {
        public Groups(string sConnString)
            : base(sConnString)
        {
        ...
        public DataSet GetAllGroupMembers(int GroupID, out Int16 retVal, out String retMessage)
        {
            SqlCommand sqlCmd = default(SqlCommand);
            SqlConnection sqlCon = null;
            SqlDataAdapter da = null;
            DataSet GroupMembers = null;

            try
            {
                sqlCon = Connection;
                sqlCmd = new SqlCommand("GT_GetAllGroupMembers", sqlCon);
                ...
                GroupMembers = new DataSet();
                da.Fill(GroupMembers);

            }
            catch (Exception ex)
            {
                Logger.ExceptionLog("GT_GetAllGroupMembers----" + ex.StackTrace);
                throw ex;
            }
        ...
        public DataSet MemberLeaveFromGrpCall(int userId, int grpTalkID, out short leaveStatus, out string grpTalkName, out string deviceToken, out short osID, out string hostMobile, out string schTime, out short retVal, out string retMessage, out string leaveMemName, out int errorCode,out string appVersion)
        {
            ...
            try
            {
                ...
                leaveCmd.Parameters.Add("@AppVersion", SqlDbType.VarChar, 6).Direction = ParameterDirection.Output;
            ...
            if (Convert.ToInt32(leaveCmd.Parameters["@RetVal"].Value) == 1)
            {
                ...
                appVersion = leaveCmd.Parameters["@AppVersion"].Value.ToString();
                retMessage = "Success";
            }
            else
            {
        ...
        public DataSet CreateGrpCall(DataTable conferenceMembers, int userId, grpcreate grpObj, int HostIsDND, out short retVal, out string retMessage, out int errorCode)
        {
            ...
            try
            {
                ...
                sqlCmd.Parameters.Add("@ConferenceEndDate", SqlDbType.VarChar, 50).Value = grpObj.EndDate;
                sqlCmd.Parameters.Add("@ConferenceEndTime", SqlDbType.VarChar, 50).Value = grpObj.EndTime;
        ...
        public DataSet GetAllGroupCalls(int userId, int AppSource, string DeviceToken, string AppVersion, string TimeStamp, out string outTimeStamp, out int count, out double userBal, out string profileImagePath, out string userCurrentDate, out string userRegTimeStamp, out int retVal, out string retMessage, out int errorCode)
        {
            ...
            {
                sqlCon = Connection;
                sqlCmd = new SqlCommand("GT_V_1_5_GetAllGroupCalls", sqlCon);
                sqlCmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet GetConferenceRoomBackUp(int confID, int userID, out short retVal, out string retMsg, out string serverTime, out string startTime, out int errorCode,out byte conferenceState)
        {
            ...
            try
            {
                ...
                sqlCmd.Parameters.Add("@ErrorCode", SqlDbType.Int).Direction = ParameterDirection.Output;
                sqlCmd.Parameters.Add("@RetMessage", SqlDbType.VarChar, 1000).Direction = ParameterDirection.Output;
                sqlCmd.Parameters.Add("@servertime", SqlDbType.DateTime).Direction = ParameterDirection.Output;
                sqlCmd.Parameters.Add("@starttime", SqlDbType.DateTime).Direction = ParameterDirection.Output;
                sqlCmd.Parameters.Add("@ConferenceState", SqlDbType.TinyInt).Direction = ParameterDirection.Output;
                ...
                errorCode = Convert.ToInt32(sqlCmd.Parameters["@ErrorCode"].Value);
                retMsg = sqlCmd.Parameters["@RetMessage"].Value.ToString();
                conferenceState = Convert.ToByte(sqlCmd.Parameters["@ConferenceState"].Value);
                if (retVal == 1)
                {
        ...
        public DataSet SaveContactsToConference(DataTable members, int userID, int confID, string webListIds, short mode, out int retVal, out string retMessage, out int errorCode)
        {
            ...
            try
            {
                ...
                sqlCmd.Parameters.Add("@Mode", SqlDbType.TinyInt).Value = mode;
        ...
        public DataSet InAppPurchaseHistory(int userID)
        {
            ...
            try
            {
                ...
                sqlCon = Connection;
                sqlCmd = new SqlCommand("GT_V_1_5_GetInAppPurchaseHistory", sqlCon);
                sqlCmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataSet UpdateGrpSettings(int userID, grpEdit editGrp, out short retVal, out string retMsg)
        {
            SqlCommand sqlCmd = default(SqlCommand);
            SqlConnection sqlCon = null;
            DataSet ds = new DataSet();
            ...
            try
            {
                sqlCon = new SqlConnection();
                sqlCon = Connection;
                sqlCmd = new SqlCommand("UpdateGroupSettings", sqlCon);
                sqlCmd.CommandType = CommandType.StoredProcedure;
                sqlCmd.Parameters.Add("@ConfId", SqlDbType.BigInt).Value = editGrp.grpcallID;
                sqlCmd.Parameters.Add("@IsMuteDial", SqlDbType.TinyInt).Value = editGrp.IsMuteDial;
                sqlCmd.Parameters.Add("@IsOnlyDialIn", SqlDbType.TinyInt).Value = editGrp.IsOnlyDialIn;
                sqlCmd.Parameters.Add("@IsAllowNonMembers", SqlDbType.TinyInt).Value = editGrp.IsAllowNonMembers;
                sqlCmd.Parameters.Add("@OpenLineBefore", SqlDbType.TinyInt).Value = editGrp.OpenLineBefore;
                sqlCmd.Parameters.Add("@RetVal", SqlDbType.TinyInt).Direction = ParameterDirection.Output;
                sqlCmd.Parameters.Add("@RetMessage", SqlDbType.VarChar, 1000).Direction = ParameterDirection.Output;
                da = new SqlDataAdapter(sqlCmd);
                da.Fill(ds);
            ...
            {
                Logger.ExceptionLog("exception in UpdateGrpSettings DAl :" + ex.ToString());
                throw ex;
                sqlCon.Close();
        ...
        public void UpdateGroupMemberStatus(int userId, long grpId, string mobileNumber, string newNumber, short isDndFlag, short mode, out short retVal, out string retMsg)
        {
            SqlCommand sqlCmd = default(SqlCommand);
            SqlConnection sqlCon = null;
            ...
            try
            {
                sqlCon = new SqlConnection();
                sqlCon = Connection;
                sqlCmd = new SqlCommand("UpdateGroupMemberStatus", sqlCon);
                sqlCmd.CommandType = CommandType.StoredProcedure;
                sqlCmd.Parameters.Add("@Mode", SqlDbType.TinyInt).Value = mode;
                sqlCmd.Parameters.Add("@ConfId", SqlDbType.BigInt).Value = grpId;
                sqlCmd.Parameters.Add("@UserId", SqlDbType.BigInt).Value = userId;
                sqlCmd.Parameters.Add("@MobileNumber", SqlDbType.VarChar, 20).Value = mobileNumber;
                sqlCmd.Parameters.Add("@EditNewNumber", SqlDbType.VarChar, 20).Value = newNumber;
                sqlCmd.Parameters.Add("@RetVal", SqlDbType.TinyInt).Direction = ParameterDirection.Output;
                sqlCmd.Parameters.Add("@RetMsg", SqlDbType.VarChar, 1000).Direction = ParameterDirection.Output;
                sqlCon.Open();
                sqlCmd.ExecuteNonQuery();
                sqlCon.Close();
                retVal = Convert.ToInt16(sqlCmd.Parameters["@RetVal"].Value);
                retMsg = Convert.ToString(sqlCmd.Parameters["@RetMsg"].Value);
            }
            catch (Exception ex)
            {
                Logger.ExceptionLog("exception in UpdateGroupMemberStatus DAL :" + ex.ToString());
                throw ex;
