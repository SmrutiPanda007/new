...
{
    public class GroupcallReports : DataAccess
    {
        ...
        public GroupcallReports(string sConnString)
            : base(sConnString)
        {
        ...
        public DataTable Download_ExcelFile(string batchId, out int retVal, out string retMesasge, out string reportName)
        {
            ...
            {
                sqlConn = Connection;
                SqlCommand sqlCmd = new SqlCommand("GT_HistoryForBatchId", sqlConn);
                sqlCmd.CommandType = CommandType.StoredProcedure;
                sqlCmd.Parameters.Add("@BatchId", SqlDbType.VarChar, 40).Value = batchId;
                sqlCmd.Parameters.Add("@ReportName", SqlDbType.VarChar, 100).Direction = ParameterDirection.Output;
                sqlCmd.Parameters.Add("@RetVal", SqlDbType.Int).Direction = ParameterDirection.Output;
                sqlCmd.Parameters.Add("@RetMessage", SqlDbType.VarChar, 100).Direction = ParameterDirection.Output;
                SqlDataAdapter da = new SqlDataAdapter(sqlCmd);
                da.Fill(dt);
                reportName = Convert.ToString(sqlCmd.Parameters["@ReportName"].Value);
                retVal = Convert.ToInt16(sqlCmd.Parameters["@RetVal"].Value);
                retMesasge = Convert.ToString(sqlCmd.Parameters["@RetMessage"].Value);
            }
            catch (Exception ex)
            {
                Logger.ExceptionLog("Exception in History download to excel is " + ex.ToString());
            }
            return dt;
        }

        public DataTable SendEmailReportOfGroup(int userId, long grpId, string batchId, out short retVal, out string retMsg)
        {
            SqlConnection sqlConn = new SqlConnection();
            ...
            {
                sqlConn = Connection;
                SqlCommand sqlCmd = new SqlCommand("GT_SendEmailOfGrpReports", sqlConn);
                sqlCmd.CommandType = CommandType.StoredProcedure;
                sqlCmd.Parameters.Add("@UserId", SqlDbType.Int).Value = userId;
                sqlCmd.Parameters.Add("@ConfId", SqlDbType.Int).Value = grpId;
                sqlCmd.Parameters.Add("@BatchId", SqlDbType.VarChar, 100).Value = batchId;
                sqlCmd.Parameters.Add("@RetVal", SqlDbType.Int).Direction = ParameterDirection.Output;
            ...
            {
                Logger.ExceptionLog("Exception in SendEmailReportOfGroup DAL" + ex.ToString());
            }
            return dt;
        }

        public DataTable SendReportsMail(int userId, long grpId, string fileName, out short retVal, out string retMsg)
        {
            SqlConnection sqlConn = new SqlConnection();
            DataTable dt = new DataTable("dt1");
            retVal = 0;
            ...
            {
                sqlConn = Connection;
                SqlCommand sqlCmd = new SqlCommand("GT_SendReportsMail", sqlConn);
                sqlCmd.CommandType = CommandType.StoredProcedure;
                sqlCmd.Parameters.Add("@UserId", SqlDbType.Int).Value = userId;
                sqlCmd.Parameters.Add("@ConfId", SqlDbType.Int).Value = grpId;
                sqlCmd.Parameters.Add("@FileName", SqlDbType.VarChar, 100).Value = fileName;
                sqlCmd.Parameters.Add("@RetVal", SqlDbType.Int).Direction = ParameterDirection.Output;
                sqlCmd.Parameters.Add("@RetMsg", SqlDbType.VarChar, 1000).Direction = ParameterDirection.Output;
                SqlDataAdapter da = new SqlDataAdapter(sqlCmd);
                da.Fill(dt);
