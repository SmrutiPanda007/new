<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="GrpTalk.Home" %>
...
<head>
    ...
    <style type="text/css">
		...
		#login_changes{#login_changes {background-color: #fff;padding-top: 60px;min-height: 560px;}}
		#lblSignIn{color:#767676 ! important;}
		#main-slider .slider-inner h2 span{font-size:70px !important; margin-top:220px;} 
	div#ddlMenu { background-color: whitesmoke;padding-top: 40px; border-bottom: 1px solid #d6d6d6;}
	#main-slider .slider-inner .btn { margin: 10px 0px !important;}
	</style>
    <script>
...
<body id="home" class="homepage">
								...
								<div class="row">
									<div class="col-sm-6 text-right">
										<div class="carousel-content">
											...
											<p style="font-size: 1em; margin-top:-20px;">Group Calling Simplified</p>
										</div>
									</div>
									<div class="col-sm-6 text-left">
										<div class="carousel-content">
											<img src="images/1.png" class="img-responsive" alt="Phn" style="margin-top: 85px;" />
										</div>
									</div>
								</div>
							</div>
							<div class="col-sm-6">
								<div style="background:#fff; border-left:5px solid #1770b7; min-height:560px;">

												
							
								<div class="text-center"> 
									<span id="qrChannel" style="display:none;"> </span>
									<img id="imgQrCode" src="/images/load.gif" alt="Qr image Not Loaded" style=" margin-top: 50px;height:40%;width:40%;" />
									<br>
									<input id="chkLogin" style="color: red !impotant;" type="checkbox">
									<b id="lblSignIn"> Keep me signed in</b>
									<br>
									<h4 style="font:normal 23px Calibri; color:#45aed6;">Use grpTalk on your phone to scan the code</h4>
									<label style="color:#333;font-weight:normal;">Open grpTalk - menu - grpTalk Web</label>
								</div>
                            <hr/>
							<!-- <div class="col-md-12 text-center margin-top-20" style="color:black"> Download the app and experience the world class audio conferencing</div>			 -->
								<div class="text-center" >
									<div class="col-md-2" style="border-right:1px solid #d2d2d2"><img src="images/android.png" width="50" height="50"/></div>
									<div class="col-md-10 pull-left" ><h2 class="text-left" style="text-align:left; font:bold 22px Calibri; color:#283339;  margin:0px;">Android</h2> <p class="text-left" style="text-align:left; font:normal 16px Calibri; color:#283339;">Available On <a href="https://play.google.com/store/apps/details?id=com.mobile.android.grptalk">Play Store</a></p></div>
								<div class="clearfix"></div>
								</div>
								<div class="text-center" style="margin-top:20px;">
									<div class="col-md-2" style="border-right:1px solid #d2d2d2"><img src="images/IOS.png" width="50" height="50" /></div>
									<div class="col-md-10 pull-left"><h2 class="text-left" style="text-align:left; font:bold 22px Calibri; color:#283339;  margin:0px;">IOS</h2> <p class="text-left" style="text-align:left; font:normal 16px Calibri; color:#283339;">Available On <a href="https://itunes.apple.com/in/app/grptalk/id1074172134?ls=1&amp;mt=8">App Store</a></p></div>
									<div class="clearfix"></div>							  
								</div>
    ...
    <script src="Scripts/home.js?type=2" type="text/javascript"></script>
