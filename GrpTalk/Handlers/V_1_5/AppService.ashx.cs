...
namespace GrpTalk.Handlers.V_1_5
{
    /// <summary>
    ...
    public class AppService : IHttpHandler
    {
        ...
        {
            Logger.TraceLog("Initial request app"+context);
            ...
            if (userId == 5 || userId == 1 || userId == 2 || userId == 62497)
            {
            ...
            switch (actionName)
            {
                ...
                case ApiHelper.ChangeTimeZone:
                    ChangeTimeZone(context);
                    break;
                case ApiHelper.UpdateGrpMemberStatus:
                    UpdateGroupMemberStatus(context);
                    break;
                case ApiHelper.GetAllGroupMembers:
                    GetAllGroupMembers(context);
                    break;
                case ApiHelper.UpdateGrpSettings:
                    UpdateGrpSettings(context);
                    break;
                case ApiHelper.ClickToSendEmailForReports:
                    SendEmailReportOfGroup(context);
                    break;
                case "IOSPUSH":
                    IOSPUSH();
                    break;
        ...
        public void SendEmailReportOfGroup(HttpContext context)
        {
            ...
            GroupCallReports reportObj = new GroupCallReports();
            responseJobj = reportObj.SendEmailReportOfGroup(MyConf.MyConnectionString, userId, _ParamObj);
            context.Response.Write(responseJobj);

        }

        public void UpdateGrpSettings(HttpContext context)
        {
            JObject responseJobj = new JObject();
            context.Request.InputStream.Position = 0;
            StreamReader _IS = new StreamReader(context.Request.InputStream);
            string _Payload = _IS.ReadToEnd();
            JObject _ParamObj = JObject.Parse(_Payload);
            Groups profileObj = new Groups();
            responseJobj = profileObj.UpdateGrpSettings(MyConf.MyConnectionString, userId, _ParamObj);
            context.Response.Write(responseJobj);

        }
        public void UpdateGroupMemberStatus(HttpContext context)
        {
            JObject responseJobj = new JObject();
            context.Request.InputStream.Position = 0;
            StreamReader _IS = new StreamReader(context.Request.InputStream);
            ...
            JObject _ParamObj = JObject.Parse(_Payload);
            Groups profileObj = new Groups();
            responseJobj = profileObj.UpdateGrpMemberStatus(MyConf.MyConnectionString, userId, _ParamObj);
            context.Response.Write(responseJobj);

        }
        public void ChangeTimeZone(HttpContext context)
        {
            JObject responseJobj = new JObject();
            context.Request.InputStream.Position = 0;
            StreamReader _IS = new StreamReader(context.Request.InputStream);
        ...
        public void PhoneContactsSync(HttpContext context)
        {
            ...
            string _Payload = _IS.ReadToEnd();
            JObject _ParamObj = JObject.Parse(_Payload);
            GT.BusinessLogicLayer.V_1_5.Profile profObj = new GT.BusinessLogicLayer.V_1_5.Profile();
        ...
        private void LeaveGroupCall(HttpContext context)
        {
            ...
            {
                GT.BusinessLogicLayer.V_1_5.Groups groupsObj = new GT.BusinessLogicLayer.V_1_5.Groups();
                outputLeaveGrpObj = groupsObj.MemberLeaveFromGrpCall(MyConf.MyConnectionString, Convert.ToInt32(context.Request["ConferenceID"]), userId, Convert.ToInt32(context.Request["isSecondaryModerator"]));
            }
            catch (Exception ex)
            {
        ...
        public void GetAllGroupMembers(HttpContext context)
        {
            
           
            JObject groupMembersObj = new JObject();
            try
            {
                int GroupID=0;
                if (string.IsNullOrEmpty(context.Request["GroupID"]) == true)
                {
                    groupMembersObj = new JObject(new JProperty("Success", false),
                        new JProperty("Message", "GroupID Parameter Missing"),
                        new JProperty("ErrorCode", "111"));
                    context.Response.Write(groupMembersObj);
                    context.Response.End();
                }
                else{
                ...
                GT.BusinessLogicLayer.V_1_5.Groups GroupsObj = new GT.BusinessLogicLayer.V_1_5.Groups();
                groupMembersObj = GroupsObj.GetAllGroupMembers(MyConf.MyConnectionString,GroupID);
            }
        ...
        public void GetAllGroupCalls(HttpContext context)
        {
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(context.Request.Headers["AppVersion"]) == true)
                {
                    appVersion = "";
                }
                ...
                {
                    appVersion = context.Request.Headers["AppVersion"].ToString();
                }
        ...
        public void GetReportsByBatchIdNew(HttpContext context)
        {
            ...
            try
            {
                ...
                GT.BusinessLogicLayer.V_1_5.GroupCallReports groupcallReportsObj = new GT.BusinessLogicLayer.V_1_5.GroupCallReports();
        ...
        private void ValidateOTP(HttpContext context)
        {
            ...
            try
            {
                ...
                GT.BusinessLogicLayer.V_1_5.Login loginObj = new GT.BusinessLogicLayer.V_1_5.Login();
                validateObj = loginObj.ValidateOTP(MyConf.MyConnectionString, mobile, context.Request["Otp"].ToString(), txnID, 0,countryID);
        ...
        private void UpdateProfile(HttpContext context)
        {
            ...
            string payload = _IS.ReadToEnd();
            int userId = 0;
            string nickName = "", email = "", company = "", offSetValue = "";
            try
            {
                ...
                GT.BusinessLogicLayer.V_1_5.Profile profileObj = new GT.BusinessLogicLayer.V_1_5.Profile();
                updateProfileObj = profileObj.UpdateProfile(MyConf.MyConnectionString,userId, nickName, email, offSetValue, company);
        ...
        private void CheckUserConfirmation(HttpContext context)
        {
            ...
            try
            {
                ...
                GT.BusinessLogicLayer.V_1_5.Groups groupsObj = new GT.BusinessLogicLayer.V_1_5.Groups();
                responseJObj = groupsObj.CheckUserConfirmation(MyConf.MyConnectionString, _ParamObj,countryID);
                context.Response.Write(responseJObj);
