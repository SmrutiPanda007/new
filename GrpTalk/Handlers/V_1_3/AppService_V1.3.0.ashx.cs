...
using GT.BusinessLogicLayer.V_1_3;
using System.Drawing;


namespace GrpTalk.Handlers.V_1_3
{
    /// <summary>
    /// Summary description for AppService_V1__3__0
    /// </summary>
    public class AppService_V1__3__0 : IHttpHandler
    {
        ...
        public void PhoneCallHistroySync(HttpContext context)
        {
            ...
            Contacts_V130 contactsObj = new Contacts_V130();
        ...
        public void OtpCall()
        {
            Login_V130 loginObj = new Login_V130();
        ...
        public void GetUserDetails(HttpContext con)
        {
            ...
            Profile_V130 profileObj = new Profile_V130();
        ...
        public void IOSPUSH()
        {
            ...
            obj.IOSpush("a866689f2658caffc2a1f97260b17366ae1fcd504a6f2be8609d1dc2085787fe", "hi");
        ...
        public void GroupCallHistory(HttpContext context)
        {
            ...
            try
            {
                Groups_V130 groupsObj = new Groups_V130();
        ...
        public void PhoneContactsSync(HttpContext context)
        {
            ...
            string _Payload = _IS.ReadToEnd();
            JObject _ParamObj = JObject.Parse(_Payload);
            Profile_V130 profObj = new Profile_V130();
        ...
        private void Dial(HttpContext context)
        {
            ...
            GroupCall_V130 groupCallObj = new GroupCall_V130();
        ...
        public void GetReportsByBatchIdNew(HttpContext context)
        {
            ...
            try
            {
                ...
                GroupCallReports_V130 groupcallReportsObj = new GroupCallReports_V130();
        ...
        private void WebLoginCheck(HttpContext context)
        {
            ...
            try
            {
                GT.BusinessLogicLayer.V_1_3.Login_V130 loginObj = new Login_V130();
