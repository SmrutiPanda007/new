(function (venn) {
    ...
    * have opposite signs */
    ...
    venn.drawD3Diagram = function (element, dataset, width, height, parameters) {
        ...
        //  .style("fill-opacity", 0.2)
               ...
               .attr("cy", function (d) { return d.y; })
                ...
                .attr("data-original-title", function (d, i) {
                    if (i == 1) {
                        return 'Attended participants - click for details';
                    } else {
                        return 'Total participants - click for details';
                    }
                })
        ...
        //.style("fill", "rgba(255, 99, 77, 0.92");
        ...
        var text = nodes.append("text")
               ...
               .attr("x", function (d, i) {
                   if (i == 0) {
                       d.textCenter.x = 24;
                       return Math.floor(d.textCenter.x);
                   } else {
                       return Math.floor(d.textCenter.x)
                   }
               })
