...
namespace GT.BusinessLogicLayer.V_1_3
{
    public class GroupCall_V130
    {
        ...
        {
            Logger.TraceLog("Dial Ap3" + inputStrmObj.ToString());
            ...
            try
            {
                ...
                if (inputStrmObj.SelectToken("IsMute") != null)
                {
                    ...
                    else if (Convert.ToBoolean(inputStrmObj.SelectToken("IsMute").ToString()) == true)
                    {
                        isMute = true;
                    }
                    else
                ...
                if (string.IsNullOrEmpty(Convert.ToString(inputStrmObj.SelectToken("IsCallFromBonus"))) == false && Convert.ToInt16(Convert.ToString(inputStrmObj.SelectToken("IsCallFromBonus"))) == 1)
                {
        ...
        public JObject Dial(string sConnString, grpcall grpCallProp, string grpCallCallBackUrl, DataTable NodeDependedMobileNumberReportIdTable, DataTable NodeDependendGateWaysTable, int isCallFromWeb)
        {
            ...
            try
            {
                ...
                {
                    DataAccessLayer.V_1_3.GroupCall_V130 groupcallObj = new DataAccessLayer.V_1_3.GroupCall_V130(sConnString);
                    ...
                    if (ReportIdMobileNumberTable.Rows.Count > 0)
                    {
                        ...
                        for (int i = 0; i <= ReportIdMobileNumberTable.Rows.Count - 1; i++)
                        {
                            ...
                            if (Convert.ToInt32(GateWayDetailsTable.Select("GatewayId=" + ReportIdMobileNumberTable.Rows[i]["GatewayId"])[0]["GatewayId"]) == 18)
                            {
                                ...
                                {
                                    mobileNumbers += "@" + nos[j].Substring(nos[j].Length - 10);
                                }
                            }
        ...
        public JObject MuteUnmuteApi(string memberIds, grpcall grpCallPropObject, DataTable membersCountTable)
        {
            ...
            try
            {
                ...
                Pusher_Conference_MuteUnMuteAndDeafUnDeaf(grpCallPropObject.MemberName, httpApiResponseString, grpCallPropObject.ConferenceRoom, grpCallPropObject.IsMute, "Mute", grpCallPropObject.IsAll, grpCallPropObject.MobileNumber, membersCountTable);
        ...
        public JObject ValidateGrpCall(grpcall gCallObj, string connString)
        {
            ...
            try
            {
                DataAccessLayer.V_1_3.GroupCall_V130 groupcallObj = new DataAccessLayer.V_1_3.GroupCall_V130(connString);
            ...
            if (!string.IsNullOrEmpty(grpCallProp.WelcomeClip))
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            _Xml = _Xml + " method=\'GET\' maxMembers=\'3000\'  timeLimit =\'" + grpCallProp.TimeLimit.ToString() + "\' endConferenceOnExit=\'true\' callbackUrl=\'" + grpCallCallBackUrl + "\' waitSound =\'" + grpCallProp.WaitClip + "\' digitsMatch=\'0\' >" + grpCallProp.ConferenceRoom + "</Conference></Response>";
                        }
        ...
        public void Pusher_Conference_MuteUnMuteAndDeafUnDeaf(string _Mem, string Respons, string CRoom, bool Isaction, string caction, bool is_All, string pushtonum, DataTable membersCountTable)
        {
