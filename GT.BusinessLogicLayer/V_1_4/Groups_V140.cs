...
namespace GT.BusinessLogicLayer.V_1_4
{
    public class Groups_V140
    {
        ...
        public JObject CallRecordSubscription(string sConnString, int userId, int subscribeStatus)
        {
            ...
            try
            {
                DataAccessLayer.V_1_4.Groups_V140 groupsObj = new DataAccessLayer.V_1_4.Groups_V140(sConnString);
        ...
        public JObject MemberLeaveFromGrpCall(string sConnString, int ConferenceID, int userId, int isSecondaryModerator)
        {
            ...
            try
            {
                ...
                DataAccessLayer.V_1_4.Groups_V140 leaveGroupObj = new DataAccessLayer.V_1_4.Groups_V140(sConnString);
                ds = leaveGroupObj.MemberLeaveFromGrpCall(userId, grpTalkID, out leaveStatus, out grpTalkName, out deviceToken, out osID, out hostMobile, out schTime, out retVal, out retMessage, out leaveMemName, out errorCode);
                if (retVal == 0)
                {
                ...
                else
                {
                    ...
                    if (isSecondaryModerator == 1)
                    {
                        ...
                        Logger.TraceLog("Leave mesage" + deviceToken);
                        if (osID == 1)
                        {
        ...
        public JObject GetGrpCallDetails(string sConnString, int ConferenceID, int userId)
        {
            ...
            try
            {
                ...
                string retMsg = "";
                DataSet ds = new DataSet();
                DataAccessLayer.V_1_4.Groups_V140 grpObj = new DataAccessLayer.V_1_4.Groups_V140(sConnString);
        ...
        public JObject GetAllGroupCalls(string sConnString, int userId, int AppSource, string DeviceToken, string AppVersion, string TimeStamp, int countryID)
        {
            ...
            try
            {
                ...
                allGrpCalls = groupsObj.GetAllGroupCalls(userId, AppSource, DeviceToken, AppVersion, TimeStamp, out outTimeStamp, out count, out userBal, out profileImagePath, out userCurrentDate, out userRegTimeStamp, out retVal, out retMessage, out webListsTimeStamp, out errorCode);
                if (retVal == 1)
                {
                    if (countryID == 19)
                    {
                    ...
                    {
                        minimumBalance = ConfigurationManager.AppSettings["UkMinimumbalance"].ToString();
                    }
                    else
                    {
                    ...
                    if (allGrpCalls.Tables[0].Rows.Count > 0)
                    {
                        for (int i = 0; i <= allGrpCalls.Tables[0].Rows.Count - 1; i++)
                        {
                            ...
                            foreach (DataRow row in result)
                            {
                                MemObj = new JObject(new JProperty("Name", row["Name"]),
                                    new JProperty("GroupId", row["ConfID"]),
                                        ...
                                        new JProperty("IsSecondaryModerator", row["IsSecondaryModerator"]));
                            ...
                            allGrpCallsJarr.Add(new JObject(new JProperty("GroupID", _with3.Rows[i]["conferenceid"].ToString()),
                                                ...
                                                new JProperty("IsOnlyDialIn", Convert.ToInt16(_with3.Rows[i]["IsOnlyDialIn"].ToString())),
                                                ...
                                                new JProperty("GroupCallPin", _with3.Rows[i]["ConferencePin"].ToString()),
                                                ...
                                                new JProperty("SecondaryModerNumber", _with3.Rows[i]["SecondaryModerNumber"].ToString()),
                                                new JProperty("SecondaryModeratorName", _with3.Rows[i]["SecondaryModeratorName"].ToString()),
                                                ...
                                                new JProperty("Upcoming", upcomingJarr),
                                                new JProperty("LeaveParticipants", leaveParticipantsJarr),
                                                new JProperty("IsCallFromLists", _with3.Rows[i]["IsCreatedByList"].ToString()),
                                                new JProperty("WebLists", listsJarr),
                    ...
                    bonusDuration = Convert.ToInt32(allGrpCalls.Tables[3].Rows[0]["BonusDuration"]);
                    bonusexpiryTime = allGrpCalls.Tables[3].Rows[0]["BonusExpirationTime"].ToString();
                    maxConcurrency = Convert.ToInt32(allGrpCalls.Tables[3].Rows[0]["MaxConcurrency"]);
                    if (Convert.ToInt32(allGrpCalls.Tables[3].Rows[0]["CountryID"]) == 108)
                    {
                        if (Convert.ToInt32(allGrpCalls.Tables[3].Rows[0]["IsPremiumUser"]) == 1)
                        {
                    ...
                    allGrpCallsObj = new JObject(new JProperty("Success", true),
                        new JProperty("Message", "Success"), new JProperty("ErrorCode", errorCode),
                           ...
                           new JProperty("WebListsTimeStamp", webListsTimeStamp),
                                        ...
                                        new JProperty("IsBonusAvailable", Convert.ToBoolean(allGrpCalls.Tables[3].Rows[0]["IsBonusAvailable"])),
                                        new JProperty("TimeZone", Convert.ToString(allGrpCalls.Tables[3].Rows[0]["TimeZone"])),
                                        ...
                                        new JProperty("Currency", allGrpCalls.Tables[3].Rows[0]["CurrencyName"].ToString()),
                                        new JProperty("RequestedAmount", allGrpCalls.Tables[3].Rows[0]["PaidAmount"].ToString()),
                                        new JProperty("RequestedMinutes", allGrpCalls.Tables[3].Rows[0]["AddedAmount"].ToString()),
                                        new JProperty("WebAccess", allGrpCalls.Tables[3].Rows[0]["WebAccess"].ToString()),
                                        new JProperty("UserName", allGrpCalls.Tables[3].Rows[0]["UserName"].ToString()),
                                        new JProperty("Email", allGrpCalls.Tables[3].Rows[0]["Email"].ToString()),
                                        new JProperty("IsPremiumUser", allGrpCalls.Tables[3].Rows[0]["IsPremiumUser"].ToString()),
                                        new JProperty("BonusExpiryIndays", allGrpCalls.Tables[3].Rows[0]["BonusExpiryIndays"].ToString()),
                                        ...
                                        new JProperty("BonusMinutes", ConfigurationManager.AppSettings["BonusMinutes"].ToString()),
        ...
        public JObject GetGroupCallRoomBackUp(string sConnString, int confID, int userID)
        {
            ...
            try
            {
                ...
                callRoomDs = groupsObj.GetConferenceRoomBackUp(confID, userID, out retVal, out retMsg, out serverTime, out startTime, out errorCode);
        ...
        public JObject AddParticipantInGroupCall(string sConnString, JObject paramObj, int userID)
        {
            ...
            try
            {
                ...
                resultDataSet = groupsObj.SaveContactsToConference(conferenceMebers, userID, confID, paramObj.SelectToken("WebListIds").ToString(), out retVal, out retMsg, out errorCode);
        ...
        public JObject CheckUserConfirmation(string sConnString, JObject paramObj)
        {
            ...
            try
            {
                DataAccessLayer.V_1_3.Groups_V130 groupsObj = new DataAccessLayer.V_1_3.Groups_V130(sConnString);
