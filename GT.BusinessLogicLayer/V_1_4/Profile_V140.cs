    ...
    public class Profile_V140
    {
        ...
        public JObject GetProfileDetailsDisplay(string sConnString, int userId, int mode)
        {
            ...
            try
            {
                int retVal = 0;
                string retMessage = "";
                DataAccessLayer.V_1_4.Profile_V140 profileObj = new DataAccessLayer.V_1_4.Profile_V140(sConnString);
        ...
        public JObject UpdateProfile(string sConnString, int userID, string nickName, string emailID, string offSet, string workNumber, string webSiteURL, string company)
        {
            ...
            try
            {
                ...
                DataAccessLayer.V_1_4.Profile_V140 profileObj = new DataAccessLayer.V_1_4.Profile_V140(sConnString);
                Logger.TraceLog("Update Profile");
                ds = profileObj.UpdateProfile(userID, nickName, emailID, offSet, workNumber, webSiteURL, company, out retVal, out retMsg, out errorCode);
                if (retVal == 1)
                {
