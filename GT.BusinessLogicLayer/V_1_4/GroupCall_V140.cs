...
namespace GT.BusinessLogicLayer.V_1_4
{
    public class GroupCall_V140
    {
        ...
        public JObject Dial(string sConnString, grpcall grpCallProp, string grpCallCallBackUrl, DataTable NodeDependedMobileNumberReportIdTable, DataTable NodeDependendGateWaysTable, int isCallFromWeb)
        {
            ...
            Logger.TraceLog("DIal Grpcall  " + grpCallProp.ToString());
            ...
            try
            {
                ...
                {
                    DataAccessLayer.V_1_4.GroupCall_V140 groupcallObj = new DataAccessLayer.V_1_4.GroupCall_V140(sConnString);
        ...
        ConnectRetry:
            ...
            catch (System.Net.WebException ax)
            {
                ...
                if (sendMails == 1 && retryAttempt >2)
                {
                    ...
                    DataAccessLayer.V_1_4.GroupCall_V140 sendMail = new DataAccessLayer.V_1_4.GroupCall_V140(sConnString);
        ...
        public JObject ValidateHangUpAction(string sConnString, JObject hangUpObj, int userId)
        {
            ...
            try
            {
                ...
                if (isAll == true && grpCallPropObj.Direction == "1")
                {
                    ...
                    pusherAppSecret =
                        System.Configuration.ConfigurationManager.AppSettings["PusherAppSecret"].ToString();
        ...
        public JObject ValidateGrpCall(grpcall gCallObj, string connString)
        {
            ...
            try
            {
                DataAccessLayer.V_1_4.GroupCall_V140 groupcallObj = new DataAccessLayer.V_1_4.GroupCall_V140(connString);
        ...
        private JObject TransferCallToPrivateOrPublic(string sConnString, grpcall grpCallObj)
        {
            ...
            try
            {
                DataAccessLayer.V_1_4.GroupCall_V140 groupcallObjDAL = new DataAccessLayer.V_1_4.GroupCall_V140(sConnString);
        ...
        public JObject PrivatePublicApi(string confereceRoom, string freeSwitchMemberId, bool toPrivate, string httpUrl, bool muteValue)
        {
            ...
            HttpWebRequest apiRequest = WebRequest.Create(nodeUrl) as HttpWebRequest;
