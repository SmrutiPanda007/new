...
namespace GT.BusinessLogicLayer.V_1_4
{
    public class Login_V140
    {
        ...
        public JObject OtpCall(string sConnString, string mobile)
        {
            ...
            DataAccessLayer.V_1_4.Login_V140 loginObj = new DataAccessLayer.V_1_4.Login_V140(sConnString);
            try
            {
                    ...
                    else
                    {
                        if (!string.IsNullOrEmpty(otp))
                        {
                            ...
                            if (!string.IsNullOrEmpty(otp))
                            {
                                ...
                                else if (mobile.Replace(" ", "").StartsWith("44"))
                                {
                                    fromNumber = ConfigurationManager.AppSettings["UkCallMeNumber"].ToString();
                                }
                                else
                                {
        ...
        public JObject Registration(string sConnString, JObject paramObj, string clientIpAddr, string txnID, Boolean isResend, int countryID)
        {
            ...
            {
                missedCallNumber = ConfigurationManager.AppSettings["UkMissedCallNumber"].ToString();
            }
            else
            {
        ...
        public JObject QrCodeLogout(JObject jobj, string sConnString, int userId)
        {
            ...
            try
            {
                ...
                {
                    GT.DataAccessLayer.V_1_4.Login_V140 loginObj = new DataAccessLayer.V_1_4.Login_V140(sConnString);
